...
export default {
  translation: {
    ...
    'sign-in-fail-title': 'Не удалось авторизоваться',
    'sign-in-fail-description': 'Время ожидания истекло или произошла отмена. Пожалуйста, вернитесь в лаунчер, чтобы инициировать новый сеанс авторизации',
    ...
    'change-account': 'Сменить учетную запись',
    'sign-in-browser': 'Авторизуйтесь в открытом браузере. Страница обновится когда все будет готово',
    'errors': {
